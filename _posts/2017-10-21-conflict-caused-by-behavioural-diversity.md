...
If you're on an agile team that is delivering software, then I'd have to say by far one of most important aspects to consider, are relating to the team, 'us', the people, the team members themselves. And more specifically, how we behave and communicate with one another - if behavioural diversity can cause conflict, then does that mean 'conflict' is bad? Do 'behaviour' and 'personality type' assessments really help us gauge an understanding of ourselves and others? And can human social behaviour even be straight forward to understand?
