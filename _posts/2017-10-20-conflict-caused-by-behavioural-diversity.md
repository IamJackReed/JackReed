...
---
<span style="color:#00000; font-family: 'open sans'; font-size: 1em; font-size: 20px; font-weight: 200; hyphens: none;">By far one of the most difficult challenges that I've found working with agile teams, it isn't dealing with the typical constraints that a project might have; scope, costs, quality, or even time. I'd have to say that the most difficult challenge, 90% of the time is 'us', the people. More specifically, how we behave and communicate with one another - if behavioural diversity can cause conflict, is 'conflict' all that bad? Does using 'behaviour' and 'personality types' assessments really help us gauge an understanding of ourselves and others? Is human social behaviour straight forward?
