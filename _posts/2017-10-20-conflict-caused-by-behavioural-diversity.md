...
---
<span style="color:#00000; font-family: 'open sans'; font-size: 1em; font-size: 20px; font-weight: 200; hyphens: none;">By far one of the most difficult challenges that I've found in working with agile teams, isn't dealing with the typical constraints; scope, costs, quality, or even time. I'd have to say, that one of most difficult challenges to overcome often seems to be 'us', the people. More specifically, how we behave and communicate with one another - if behavioural diversity can cause conflict, is 'conflict' all that bad? Does using 'behaviour' and 'personality types' assessments really help us gauge an understanding of ourselves and others? Is human social behaviour straight forward?
