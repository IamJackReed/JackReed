...
---
<span style="color:#00000; font-family: 'open sans'; font-size: 1em; font-size: 20px; font-weight: 200; hyphens: none;">By far one of the most difficult challenges that I've found working with agile teams, is not dealing with the typical constraints; scope, costs, quality, or even time. Although, they all play an important part, and most of the time still be challenging. However, I'd have to say that the biggest challenge, 90% of the time is 'us', the people. More specifically, how we behave and communicate with one another - if behavioural diversity can cause conflict, is 'conflict' all that bad? Does using 'behaviour' and 'personality types' assessments really help us gauge an understanding of ourselves and others? Is human social behaviour straight forward?

## Is 'conflict' all that bad?
<span style="color:#00000; font-family: 'open sans'; font-size: 1em; font-size: 20px; font-weight: 200; hyphens: none;">Almost all teams will eventually experience some form of conflict sooner or later. And in some cases, particularly in a scrum team it can even be desirable, so long as the conflicts that occur have a positive outcome. If a team are aware of their team members behavioural differences, and they all use a style that allows them to fully express their opinion without causing others to get stressed or take offence, then there could be some positive outcomes, some of which might include:  
